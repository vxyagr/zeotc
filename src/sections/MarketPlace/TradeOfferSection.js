...
export default function MarketPlaceSection({
  ...
  const { mutate: rejectOffer, isLoading: isRejectLoading } =
    useMutationReject();

  const { mutate: cancelSwap, isLoading: isCancelLoading } =
    useMutationCancelZeSwap();
  ...
  const isCountered = demander != zeroAddress;
